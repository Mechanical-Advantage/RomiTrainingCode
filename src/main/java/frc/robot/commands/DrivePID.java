...
public class DrivePID extends CommandBase {
  ...
  private final double pidTolerance = 0;
  ...
  public DrivePID(Drivetrain drive, double distanceInInches, double speed) {
  ...
  @Override
  public void execute() {
    double percentOut = pid.calculate(drive.getAverageDistanceInch(), setpoint);
